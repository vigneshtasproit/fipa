...
$lastRow.find("td:eq(9)").find('input:eq(0)').val($("#txtFldDlgORRemarks").val());*/
	...
	'<input type="hidden" name="txtFldothretMode" readonly="true" value="'+INS_MODE+'" class="fipaMode"/><input type="hidden" name="txtFldORId">';
	var cell1 = '<div class="checkbox checkbox-primary text-center"><input type="checkbox" name="radothretSelect"/><label>&nbsp;</label></div>'; 
	var cell2 = '<input type="text" name="txtFldORtyofpay" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);"  maxlength="150" />'; 
	var cell3 = '<input type="text" name="txtFldORAnlExp" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" />'+
	'<select type="text" name="selORFreq" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" ></select>'+
	'<input type="text" name="txtFldOREslrate" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" />'; 
	var cell4 = '<input type="text" name="txtFldORAgePaySts" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);"/>'+
	'<input type="text" name="txtFldORAgePayends" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" />'+
	...
	var cell5 ='<input type="text" name="txtFldORRemarks" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" maxlength="300"/>'+
	'<input type="hidden" name="txtFldORCrtdBy"/><input type="hidden" name="txtFldORCrtdDate"/>';
...
var cell2 = '<input type="text" name="txtFldIncAssDesc" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" maxlength="150"/>';
...
var cell3 = '<select type="text" name="txtFldIncAssClsfy" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" maxlength="150" /></select><input type="hidden" name="txtFldIncAsstSubClsfy"/>'; 
var cell4 = '<input type="text" name="txtFldIncAssAmtofInc" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" />'+
'<select type="text" name="selIncAssFreq" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" ></select>'+
'<input type="text" name="txtFldIncAssEslrate" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" />'+
'<input type="text" name="txtFldIncAssRoi" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" />';
...
var cell5 = '<input type="text" name="txtFldIncAssAgePaySts" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);"  maxlength="20"/>'+
'<input type="text" name="txtFldIncAssAgePayends" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);"  maxlength="20"/>'+
...
//	$row.find("td:eq(3)").find('input:eq(0)').val($("#txtFldDlgIncAssClsfy").val()); 
	$row.find("td:eq(3)").find('select:eq(0)').val($("#txtFldDlgIncAssClsfy").val());
