...
var cell2 = '<select  name="txtFldVehOwner" class="form-control editable form-tablecolor" ></select>';
 
var cell3 = '<input type="text" name="txtFldVehMktVal" class="form-control editable form-tablecolor" onmouseover="fipaTooltip(this);"  />'; 

var cell4 = '<input type="text" name="txtFldVehLnVal" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);"  />';
...
var cell5 = '<input type="text" name="txtFldVehiMonthInstal" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" />'+
'<input type="hidden" name="txtFldVehLnBank" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);"  />'+
'<input type="text" name="txtFldVehPerd"  class="form-control editable form-tablecolor" onmouseover="fipaTooltip(this);" />';

var cell6 = '<select name="txtFldVehiSoldOnDeath" class="form-control editable form-tablecolor"></select>'+
...
$lastRow.find("td:eq(6)").find('input:eq(1)').val($("#txtFldDlgVehRemark").val());
...
function vehfilldomval($RowId,$row){
	...
	$row.find("td:eq(6)").find('select:eq(0)').val($("#txtFldDlgVehiSoldOnDeath").val()); 
