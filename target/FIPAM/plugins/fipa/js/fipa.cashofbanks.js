...
var cell2 = '<input type="text"  name="txtFldCOBDescription" class="form-control editable form-tablecolor"  maxlength="150" />'+
'<select name="txtFldMainAccHolderName" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);"   maxlength="75"></select>'+
'<select name="selCOBOwnershipType" class="form-control editable form-tablecolor" ></select>'+
...
var cell3 = '<select  name="selCOBAccountType" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" ></select>'+
...
var cell4 = '<input type="text" name="txtFldCOBCurBalance" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" />';

var cell5 = '<select name="selCOBObjective" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" ></select>'+
'<input type="text" name="txtFldCOBRetrmntPrcnt"   class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);"  />'+
...
var cell6 = '<input type="text" name="txtFldCOBRegDeposit" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);"  />'+
'<select name="selCOBDepositFreq" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" ></select>'+
'<input type="text" name="txtFldCOBPerFrom" class="form-control editable form-tablecolor"   maxlength="10" onmouseover="fipaTooltip(this);"  />'+
'<input type="text" name="txtFldCOBPerTo" class="form-control editable form-tablecolor"   maxlength="10" onmouseover="fipaTooltip(this);" />'+
...
function Cobfilldomval($RowId,$row){
	...
	$row.find("td:eq(3)").find('select:eq(0)').val($("#selDlgCOBAccountType").val()); 
