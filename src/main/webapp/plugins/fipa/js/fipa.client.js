								...
								for ( var cont in jsnData) {
									...
									if (sublob == "ILP" || sublob == "UT") {
										...
										var cell1 = '<input type="text" readOnly="true" onmouseover="fipaTooltip(this);" class="dhtmlTableText ptrcursor" style="display:inline;width:80px"/><input type="hidden" name="strFipaLifeInsId"/><input type="hidden" name="strFnaId"/><input type="hidden" name="strFPMSAppId"/><input type="hidden" name="strFIPARefId"/>'
												+ ((AppName == "FIPA") ? fipaSymbol
														: fpmsSymbol);
										var cell2 = '<input type="text"  readOnly="true" onmouseover="fipaTooltip(this);" class="dhtmlTableText ptrcursor"/><input type="hidden"/>'+
										...
										$lastRow.find("td:eq(2)").find('input:eq(2)').val(prin);
										...
										$lastRow.find("td:eq(2)").find('input:eq(1)').val(contvalue["strFPMSPolCustName"]); 
							...
							for ( var cont in jsnData) {
								...
								if (jsnData.hasOwnProperty(cont)) {			
									...
									for(var data in contvalue){
										...
										var tpdCoverage;
										var earlyCICoverage;
										var advanceCICoverage;*/
										
										switch(data){
											case "strLifeInsCoverages":
												break;
											
											case "strLifeInsCoveragevals":
												$("#deathCoverages").text(col);
												if(col >= 2500000){
							...
							for ( var cont in jsnData) {
								...
								if (jsnData.hasOwnProperty(cont)) {			
									...
									for(var data in contvalue){
										...
										switch(data){
											case "strLifeInsTpdCoverages":
												break;
											
											case "strLifeInsTpdCoveragevals":
												$("#tpdCoverages").text(col);
												if(col >= 500000){
							...
							for ( var cont in jsnData) {
								...
								if (jsnData.hasOwnProperty(cont)) {			
									...
									for(var data in contvalue){
										...
										switch(data){
											case "strLifeInsEarlyCoverages":
												break;
											
											case "strLifeInsEarlyCoveragevals":
												$("#earlyCICoverages").text(col);
												if(col >= 300000){
													$("#earlyCiCovBackground").css("background-color", "#246961");
												}
												break;
										}
							...
							for ( var cont in jsnData) {
								...
								if (jsnData.hasOwnProperty(cont)) {			
									...
									for(var data in contvalue){
										...
										switch(data){
											case "strLifeInsAdvCoverages":
												break;
											
											case "strLifeInsAdvCoveragevals":
												$("#advancedCICoverages").text(col);
												if(col >= 500000){
